# Implement Goal stack planning for block world problems.
...
# Enter start state:- on B A^on_table A^clear B^arm_empty
# Enter goal state:- on A B^on_table B^clear A^arm_empty